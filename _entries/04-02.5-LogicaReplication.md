...
```mermaid
flowchart LR
  A[Primary server<br/>orders_demo] --> B[Publication<br/>customers_pub]
  B --> C[Subscription<br/>customers_sub]
  C --> D[Replica server<br/>orders_demo]
  D --> E[Read/verify replicated rows]
```
