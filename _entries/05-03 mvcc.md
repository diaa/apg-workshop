...
```
 Step 1: INSERT a row
 ┌──────────────────────────────────┐
 │  Row v1  [xmin=100, xmax=∞]     │  ← live row, visible to all
 └──────────────────────────────────┘

 Step 2: UPDATE the row (transaction 101)
 ┌──────────────────────────────────┐
 │  Row v1  [xmin=100, xmax=101]   │  ← dead version (old value)
 ├──────────────────────────────────┤
 │  Row v2  [xmin=101, xmax=∞]     │  ← live row (new value)
 └──────────────────────────────────┘

 Step 3: DELETE the row (transaction 102)
 ┌──────────────────────────────────┐
 │  Row v1  [xmin=100, xmax=101]   │  ← dead
 ├──────────────────────────────────┤
 │  Row v2  [xmin=101, xmax=102]   │  ← dead (marked by DELETE)
 └──────────────────────────────────┘

 Both dead versions STILL occupy disk space!
 Only VACUUM can reclaim them.
```
